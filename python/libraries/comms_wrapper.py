    ...
    def close_port(self):
        try:
            if self.arduino.isOpen() == True:
                self.arduino.close()
                print("Successfully closed connection to " + self.descriptiveDeviceName)
                # while self.__thread.is_alive() == True:    
                #     break
            self.arduino.dtr = False
            self.connectionStatus = False
            self.handshakeStatus = False
            ...
            print("!! Cannot closed connection to " + self.descriptiveDeviceName+ '!!')
            return False
